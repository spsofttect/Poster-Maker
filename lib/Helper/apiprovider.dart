// ignore_for_file: avoid_print, unnecessary_string_interpolations, prefer_typing_uninitialized_variables, prefer_const_constructors
  ...
  Future<http.Response> post(String apiurl, Object body) async {
    ...
    var response = await http
        .post(
          ...
          body: body,
          headers:
              (islogin == true /* || isGuestUser == true*/) ? headers : null,
        )
...
void logOutUSer() {
  showTostMessage(message: "Your user is logout, Please login again");
